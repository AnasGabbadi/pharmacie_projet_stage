        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="/promotions" className="hover:text-cyan-400 transition-colors">
                  Promotions
                </a>
              </li>
              <li>
                <a href="/nouveaux-produits" className="hover:text-cyan-400 transition-colors">
                  Nouveaux produits
                </a>
              </li>
              <li>
                <a href="/meilleures-ventes" className="hover:text-cyan-400 transition-colors">
                  Meilleures ventes
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="/livraison" className="hover:text-cyan-400 transition-colors">
                  Livraison
                </a>
              </li>
              <li>
                <a href="/mentions-legales" className="hover:text-cyan-400 transition-colors">
                  Mentions légales
                </a>
              </li>
              <li>
                <a href="/conditions" className="hover:text-cyan-400 transition-colors">
                  Conditions d'utilisation
                </a>
              </li>
              <li>
                <a href="/qui-sommes-nous" className="hover:text-cyan-400 transition-colors">
                  Qui sommes nous ?
                </a>
              </li>
              <li>
                <a href="/paiement" className="hover:text-cyan-400 transition-colors">
                  Paiement sécurisé
                </a>
              </li>
              <li>
                <a href="/conditions-utilisation" className="hover:text-cyan-400 transition-colors" dir="rtl">
                  شروط الإستخدام
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="/account/info" className="hover:text-cyan-400 transition-colors">
                  Informations personnelles
                </a>
              </li>
              <li>
                <a href="/account/orders" className="hover:text-cyan-400 transition-colors">
                  Commandes
                </a>
              </li>
              <li>
                <a href="/account/credits" className="hover:text-cyan-400 transition-colors">
                  Avoirs
                </a>
              </li>
              <li>
                <a href="/account/addresses" className="hover:text-cyan-400 transition-colors">
                  Adresses
                </a>
              </li>
              <li>
                <a href="/account/vouchers" className="hover:text-cyan-400 transition-colors">
                  Bons de réduction
                </a>
              </li>
            </ul>
          ...
          <div className="lg:col-span-1">
            <div className="bg-gradient-to-br from-[#93DA97] to-[#93DA97] rounded-2xl p-6 text-center relative overflow-hidden">
              {/* Mini SVG background pour la carte */}
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="text-sm text-gray-300">
              <p>
                COPYRIGHT © 2026 - paravital.ma - TOUS LES DROITS RÉSERVÉS
              </p>
